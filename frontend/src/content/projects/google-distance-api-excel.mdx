...
date: 2025-01-20
tags: [Excel, VBA, Google API, Automation, API Integration]
image: "/projects/google-distance-api-excel/excel-preview.png"
cardTitle: "Excel + Google Distance API"
cardDescription: "Real-time distance and travel-time calculation inside Excel, via the Google Distance Matrix API and VBA."
kind: automation
---
