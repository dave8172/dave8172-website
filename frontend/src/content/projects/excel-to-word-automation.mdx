...
cardTitle: "Excel-to-Word Reporting Engine"
cardDescription: "A VBA control centre that batch-exports complex Excel report sections into one brand-consistent Word document."
kind: automation
---
