...
description: "What it takes to make an AI document extraction pipeline trustworthy — eval sets, confidence scoring, audit logs, and the numbers behind it."
date: 2026-06-15
...
The first run came in at <RandomColor>79.3%</RandomColor>. That sounds bad. Turns out, it was informative.
